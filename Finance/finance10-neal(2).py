...
def get_and_plot_prices(stock_ticker_symbol, stock_data_source, stock_query_start, stock_query_end, x_axis_display, column_names):
    ...
    stock_import = import_stock_data(stock.ticker_symbol, stock.data_source, stock.query_start, stock.query_end)
    ...
    plot_prices(stock_import, y.Date.display,[y.Daily_Gain.display, y.Percent_Change.display, y.Close.display] )
